package com.aws.clouwatcghlogs.appenders;
...
public class CloudWatchAppender extends UnsynchronizedAppenderBase<ILoggingEvent> {
    ...
    public CloudWatchAppender() {
        ...
        logStreamName = "CustomCloudWatchGroupStream";

        //client = CloudWatchLogsClient.builder().region("CLOUDWATCH-REGION").build();
        client = CloudWatchLogsClient.builder().region(Region.US_EAST_1).build();
